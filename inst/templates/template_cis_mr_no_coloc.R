# =============================================================================
# ardmr template: cis-gene / drug-target MR  WITHOUT  coloc (no GWAS-VCF)
# =============================================================================
#
# Use this when:
...
ard_compare(
  ...
  sensitivity_pass_min        = 4,         # of 8; cis-MR with few IVs
...
# Notes:
# - Without coloc, MR-Egger / weighted-median / weighted-mode become the main
#   sensitivity tools. With few cis-IVs they're underpowered; expect lower
#   pass rates. Lean on Steiger directionality and leave-one-out.
